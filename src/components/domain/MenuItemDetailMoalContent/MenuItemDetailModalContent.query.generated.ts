...
export type GetMenuItemDetailModalContentQueryVariables = Types.Exact<{
...
export type GetMenuItemDetailModalContentQuery = {
  __typename: 'Query';
...
export const GetMenuItemDetailModalContentDocument = gql`
