...
import { myPageStampCard, searchItemPage, tableOrdersPage } from '@/utils/paths/facilityPages';
...
import { NavbarMenuFacilityFragment, NavbarMenuViewerFragment } from './NavbarMenu.fragment.generated';
...
type Props = {
  viewer: NavbarMenuViewerFragment;
  ...
  if (facilityId) {
    return (
      <HStack>
        ...
        {props.orderType === OrderType.EatIn && props.showOrderHistory && <OrderHistory />}
...
const UserMenu = ({ viewer }: { viewer: NavbarMenuViewerFragment }) => {
