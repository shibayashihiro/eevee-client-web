      ...
      {isDeliveryOrder && (
        ...
        >
          <Box mt="40px" mr="20px" ml="20px" mb="40px">
            ...
            {order.requirements?.requirement && (
              <Box border="2px" borderColor="mono.error" px="20px" py="20px" mb="40px" alignContent="center">
                {order.requirements.requirement.split('\n').map((requirement, index) => (
                  <Text textColor="mono.error" className="bold-medium" align="center" key={index}>
                    {requirement}
                  </Text>
                ))}
              </Box>
            ...
            <StripeProvider>
              <DeliveryOrderSubmit
                ...
                submitLabel={order.requirements?.requirementLabel ?? undefined}
